...
const std::vector<double>  Xsec_0nXnSum   = { 0.696,	0.819,	0.993 },     XsecErr_0nXnSum   = { 0.019,	0.020,	0.037 };
const std::vector<double>  Xsec_XnXn      = { 0.206,	0.248,	0.252 },     XsecErr_XnXn      = { 0.009,	0.014,	0.017 };
//------------------------------------------------------------------------------------------------------------
